  ...
  return (
    <div className="min-h-screen bg-background flex relative overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
        {/* Top-left cluster */}
        <div className="absolute top-[10%] left-[5%] opacity-[0.10] rotate-[-12deg]">
        ...
        <div className="absolute top-[20%] left-[15%] opacity-[0.08] rotate-[8deg]">
        ...
        {/* Top-right cluster */}
        <div className="absolute top-[8%] right-[10%] opacity-[0.10] rotate-[15deg]">
        ...
        <div className="absolute top-[25%] right-[5%] opacity-[0.08] rotate-[-5deg]">
        ...
        {/* Bottom-left cluster */}
        <div className="absolute bottom-[30%] left-[8%] opacity-[0.06] rotate-[5deg]">
        ...
        <div className="absolute bottom-[15%] left-[20%] opacity-[0.08] rotate-[-8deg]">
        ...
        <div className="absolute bottom-[20%] right-[15%] opacity-[0.06] rotate-[10deg]">
        ...
        <div className="absolute bottom-[35%] right-[8%] opacity-[0.08] rotate-[-15deg]">
        ...
        <div className="absolute top-[45%] left-[25%] opacity-[0.06] rotate-[3deg]">
      ...
      <motion.div
        ...
        className="hidden lg:flex flex-col justify-between w-[480px] shrink-0 px-12 py-14 relative z-10 border-r border-border/30"
      >
        {/* Logo */}
