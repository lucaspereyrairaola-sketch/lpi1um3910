            ...
            >
              <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl p-8">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-secondary/50 border border-border/50 rounded-xl py-3 text-sm font-medium text-foreground hover:bg-secondary/80 transition-colors"
                >
